...
const config: Config = {
  ...
  xrayJql: process.env.XRAY_JQL || 'fixVersion = "XRAY_VERSION_PLACEHOLDER" AND labels = "UAT" AND project = "JIRA_PROJECT_PLACEHOLDER" AND type = "test execution" ORDER BY created DESC',
